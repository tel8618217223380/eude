...
DataEngine::CheckPermsOrDie(CXX_PERSO_OWNUNIVERSE);
...
if ($cleandata && is_array($cleandata[0])) {
    ...
    //--------------------------------------------------------------------------
    $tpl->PushOutput('<tr><td colspan=12>&nbsp;</td></tr>');
    //--------------------------------------------------------------------------

    $tpl->PushOutput('<tr id="imperium_header"><td>Planète(s)</td>');
