...
DataEngine::CheckPermsOrDie(CXX_MEMBRES_ADMIN);
...
// TODO Do update routine when allys/wars table change...
$allysnb = $warsnb = -1;
...
$dates[1] = date("Y-m-d H:i:s", mktime(3, 0, 0, date("m")  , date("d")-date("w")));
$dates[2] = date("Y-m-d H:i:s", mktime(3, 0, 0, date("m")  , date("d")-date("w")-7));
$cleanvortex=null;
if (isset($_POST['cleanvortex']))
    $cleanvortex = array($cleanvortex_delete, $cleanvortex_inactif);

$tpl->admin_vortex($dates,$cleanvortex);
//---
