...
final class Config implements iDataEngine_Config {
     ...
     * @example
     * pour une adresse type: http://localhost/DataEngine/
     * [code]
     * define('ROOT_URL', '/DataEngine/');
     * [/code]
     */
    static function init() {
//        define('ROOT_URL', '/dossier/dataengine/');
//        define('ROOT_URL', '/');
    }
    /**
     ...
     * @since 1.4.1
     * @ignore if \(!defined\(\'CXX_\w+\'\)\)\s+
     */
    static function Perms() {

        // define('CXX_CARTOGRAPHIE', AXX_MEMBER);
        // define('CXX_CARTOGRAPHIE_SEARCH', AXX_MEMBER);
        // define('CXX_CARTOGRAPHIE_PLAYERS', AXX_MEMBER);
        // define('CXX_CARTOGRAPHIE_ASTEROID', AXX_MEMBER);

        // define('CXX_CARTOGRAPHIE_GREASE', AXX_MEMBER);
