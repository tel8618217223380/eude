...
if (!DataEngine::CheckPerms(CXX_CARTOGRAPHIE))
    output::Boink(ROOT_URL.'Mafiche.php');

$where = "WHERE 1=1 ";
if (DataEngine::CheckPerms(CXX_CARTOGRAPHIE_SEARCH)) {
...
if (isset($_POST['Type'])) {
    ...
    if ($_POST["phpparser"] == 1) {
        list($info, $erreur) = cartographie::getinstance()->add_solar_ss(gpc_esc($_POST["importation"]));
        $parsed = true;
    } // SS brut
...
//        list($info, $erreur) = add_player($_POST['COORIN'], $_POST['INFOS'], $_POST['USER'],$_POST['EMPIRE'], $_POST['NOTE'], $_POST['Type']);
        ...
        cartographie::getinstance()->add_player($_POST['COORIN'], $_POST['INFOS'], $_POST['USER'],$_POST['EMPIRE'], $_POST['NOTE'], $_POST['Type']);
        $parsed = true;
    }
...
//        list($info, $erreur) = add_vortex($_POST["COORIN"],$_POST["COOROUT"], $_POST["INFOS"], $_POST["USER"], $_POST["NOTE"]);
        cartographie::getinstance()->add_vortex($_POST['COORIN'],$_POST['COOROUT'], $_POST['INFOS'], $_POST['USER'], $_POST['NOTE']);
        $parsed = true;
    }
    ...
    if (!$parsed and $erreur=="" and in_array($_POST["Type"], array(2,4))) {
        ...
        list($info, $erreur) = cartographie::getinstance()->add_planet_asteroid(gpc_esc($_POST["COORIN"]), $Ress, gpc_esc($_POST["Type"]), gpc_esc($_POST["NOTE"]));
        $parsed = true;
    } // Planète/Astéroïde
...
//                list($info, $erreur) = add_player($_POST["modifCOORIN"], $_POST["modifINFOS"], $_POST["modifUSER"],$_POST["modifEMPIRE"],$_POST['NOTE'],$_POST["modifTYPE"]);
                $erreur = cartographie::getinstance()->add_player($_POST["modifCOORIN"], $_POST["modifINFOS"], $_POST["modifUSER"],$_POST["modifEMPIRE"],$_POST['NOTE'],$_POST["modifTYPE"]);
                if (!$erreur) {
                    $query="DELETE FROM SQL_PREFIX_Coordonnee_Planetes WHERE pID={$_POST["ID"]}";
                    DataEngine::sql($query);
                }
            ...
            case 4:
                ...
                cartographie::getinstance()->add_planet_asteroid($_POST["modifCOORIN"], $Ress, $_POST["modifTYPE"]);
                break;
            case 1:
                cartographie::getinstance()->add_vortex($_POST["modifCOORIN"],$_POST["modifCOOROUT"], $_POST["modifINFOS"], $_POST["modifUSER"], $_POST["NOTE"]);
                break;
...
// TODO Upgrade with new cartographie class (updater)
$erreur .= cartographie::getinstance()->Warns();
$info   .= cartographie::getinstance()->Infos();
