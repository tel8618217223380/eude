...
$out .=<<<ROWPLANET1
	<TR id='Prod_Separateur'>
	<TD height=14 colspan="11">
	<TABLE height=14 width=80% align=center>
	<TR height=14>
ROWPLANET1;
...
$out .=<<<ROWPLANET2
		<TD style='background-color:black;'
			onmouseover="document.getElementsByName('{$ligne["ID"]}ModifRessource$id')[0].style.visibility='visible';
									...
									document.getElementsByName('{$ligne["ID"]}ModifRessource$id')[0].style.width=60;"\r\n
