...
bulle;
	...
	<TR id='imperium_header'>
		...
		<TD colspan=2><input id="INTableau" type=submit value='Interpréter'><br/>
...
info;
    ...
    public function RowHeader() {
        $out=<<<h
            <TR id='imperium_header'>
		<TD>&nbsp;</TD>
		<TD><img src='%IMAGES_URL%Titane.png'>&nbsp;Titane</TD>
		<TD><img src='%IMAGES_URL%Cuivre.png'>&nbsp;Cuivre</TD>
		<TD><img src='%IMAGES_URL%Fer.png'>&nbsp;Fer</TD>
		<TD><img src='%IMAGES_URL%Aluminium.png'>&nbsp;Aluminium</TD>
		<TD><img src='%IMAGES_URL%Mercure.png'>&nbsp;Mercure</TD>
		<TD><img src='%IMAGES_URL%Silicium.png'>&nbsp;Silicium</TD>
		<TD><img src='%IMAGES_URL%Uranium.png'>&nbsp;Uranium</TD>
		<TD><img src='%IMAGES_URL%Krypton.png'>&nbsp;Krypton</TD>
		<TD><img src='%IMAGES_URL%Azote.png'>&nbsp;Azote</TD>
		<TD><img src='%IMAGES_URL%Hydrogene.png'>&nbsp;Hydrog&egrave;ne</TD>
		<TD>Total</TD>
	</TR>
h;
        $this->PushOutput($out);
    ...
    public function Planet_Header($planet) {
        ...
        $out=<<<ph
	<TR id='imperium_header'>
		<td colspan=2>{$planet['Name']}: {$planet['Coord']}</td>
		<td {$bulle}>{$planet['percent_water']}&nbsp;</td>
		<td colspan=9>&nbsp;</td>
	</tr>
ph;
        $this->PushOutput($out);
