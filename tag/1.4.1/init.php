...
// changer pour permettre plusieurs DataEngine sur la même base...
define('SQL_PREFIX_',''); // par défaut vide
 ...
 * - Les infos de debug étendue utilise "FirePHP", et est affiché uniquement au Sup-Admin. (voir Script.php)
 * @var boolean
 */
define('IN_DEV', false);
